...
function Dose() {
  return (
    <section className="main">
      ...
      <div className="about">
        <p id="textAbout">
          Bobby e Stig são dois agentes à paisana escalados para roubar um banco
          que serve de fachada para Máfia. O detalhe é que um não sabe da real
          identidade do outro. Quando eles descobrem, o mandande da tarefa
      ...
      <div id="videoContent" className="videoContent">
        <iframe
          ...
          width="760"
          height="415"
          src="https://www.youtube.com/embed/vUtmQH5o5KE?si=j37wvVO9-d0RNRnB"
