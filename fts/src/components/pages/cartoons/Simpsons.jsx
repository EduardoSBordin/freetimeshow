...
function Simpsons() {
  return (
    <section className="main">
      ...
      <div className="about">
        <p id="textAbout">
          Uma animação sobre uma típica família dos Estados Unidos. Homer é o
          pai de família nada saudável ou inteligente, que adora beber cerveja.
          Marge é a esposa e mãe de família dedicada. Bart é o filho de 10 anos,
          que não leva a escola a sério e tem orgulho disso. Lisa é a garota de
          8 anos, um gênio não apreciado. E Maggie é o bebê que não larga a
          chupeta.
        </p>
