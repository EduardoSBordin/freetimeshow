...
function BobEsponja() {
  return (
    <section className="main">
      ...
      <div className="about">
        <p id="textAbout">
          Uma esponja-do-mar chamada Bob Esponja Calça Quadrada mora com seu
          caracol de estimação na Fenda do Biquíni, no fundo do oceano. Bob
          trabalha no Siri Cascudo e, nas horas vagas, vive arrumando confusões
          com seu melhor amigo, a estrela-do-mar Patrick.
        </p>
      ...
      <div id="videoContent" className="videoContent">
        <iframe
          ...
          width="760"
          height="415"
          src="https://www.youtube.com/embed/xIFgKBUYODo?si=IQsk3N2SwTNi4FnW"
