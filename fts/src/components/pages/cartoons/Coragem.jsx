...
function Coragem() {
  return (
    <section className="main">
      ...
      <div className="about">
        <p id="textAbout">
          Coragem é um cão incrivelmente tímido e muito fácil de assustar que
          precisa defender um velho casal de aposentados de acontecimentos
          paranormais que ameaçam a segurança e a estabilidade da sua casa.
        </p>

        <div className="infoAbout">
          <p className="yearRelease">Lançamento: 1999</p>
          <p className="typeGenres">
            Genêro: Família, Sci-Fi & Fantasy, Animação, Comédia
          </p>
      ...
      <div id="videoContent" className="videoContent">
        <iframe
          ...
          width="760"
          height="415"
          src="https://www.youtube.com/embed/gbeCLHUUin8?si=ZCWwunyiIlfFRkyi"
